...
inline const char* ExplainoRootPatternRefId(ExplainoRootPatternRef value) {
    return enum_id_utils::LookupEnumId(value, enum_id_utils::kExplainoRootPatternRefIds);
}
