...
link /nologo /SUBSYSTEM:WINDOWS /OUT:"%~1" ^
  "%BUILDROOT%\main.obj" "%BUILDROOT%\json_min.obj" "%BUILDROOT%\ui_schema.obj" "%BUILDROOT%\view_hp_sync.obj" "%BUILDROOT%\explaino_seed.obj" "%BUILDROOT%\explaino_seed_dynamics.obj" "%BUILDROOT%\fractal_derived_fields.obj" "%BUILDROOT%\diagnostics_capture.obj" "%BUILDROOT%\diagnostics_state_io.obj" "%BUILDROOT%\finding_state_actions.obj" "%BUILDROOT%\finding_archive_actions.obj" "%BUILDROOT%\fractal_probe_contract.obj" "%BUILDROOT%\fractal_probe_runner.obj" "%BUILDROOT%\function_descriptor.obj" "%BUILDROOT%\render_capture_guard.obj" "%BUILDROOT%\schema_startup_policy.obj" "%BUILDROOT%\sweep_player.obj" "%BUILDROOT%\safe_mode_schema.obj" "%BUILDROOT%\schema_binding.obj" "%BUILDROOT%\lens_sdf.obj" "%BUILDROOT%\runtime_reset.obj" "%BUILDROOT%\viewer_render_pacing.obj" "%BUILDROOT%\viewer_shutdown.obj" "%BUILDROOT%\viewer_sweep.obj" "%BUILDROOT%\sample_tier_resolver.obj" "%BUILDROOT%\viewer_cli.obj" "%BUILDROOT%\viewer_schema_load.obj" "%BUILDROOT%\viewer_state_init.obj" "%BUILDROOT%\param_anim_dynamics.obj" "%BUILDROOT%\headless_modes.obj" "%BUILDROOT%\viewport_interaction.obj" "%BUILDROOT%\cli_args.obj" ^
