...
link /nologo /SUBSYSTEM:WINDOWS /OUT:"%~1" ^
  ...
  "%BUILDROOT%\imgui_impl_win32.obj" "%BUILDROOT%\imgui_impl_dx11.obj" "%BUILDROOT%\fractal_renderer.obj" "%BUILDROOT%\fractal_sample_core.obj" "%BUILDROOT%\generic_sample_core.obj" "%BUILDROOT%\lens_sdf_cuda.obj" "%BUILDROOT%\color_pipeline_sdf_postprocess_cuda.obj" ^
