...
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\json_min.cpp .\src\color_pipeline_metadata_contract.cpp .\src\explaino_seed.cpp .\src\sdf_pack.cpp .\src\lens_sdf.cpp .\src\sdf_pack_field_producer.cpp .\src\explaino_root_field.cpp .\src\explaino_root_sdf_field.cpp .\src\diagnostics_state_io.cpp .\src\diagnostics_capture.cpp .\src\render_capture_guard.cpp .\tests\test_diagnostics_state_io.cpp ^
...
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\fractal_viewport_facts.cpp .\src\finding_archive_actions.cpp .\src\json_min.cpp .\src\sdf_pack.cpp .\src\lens_sdf.cpp .\src\sdf_pack_field_producer.cpp .\src\explaino_seed.cpp .\src\explaino_root_field.cpp .\src\explaino_root_sdf_field.cpp .\src\diagnostics_capture.cpp .\src\render_capture_guard.cpp .\tests\test_finding_archive_actions.cpp ^
...
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\fractal_viewport_facts.cpp .\tests\test_fractal_viewport_facts.cpp ^
  /Fe:"%TESTROOT%\test_fractal_viewport_facts.exe"
if errorlevel 1 exit /b 1
...
if errorlevel 1 exit /b 1
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\json_min.cpp .\src\color_pipeline_metadata_contract.cpp .\src\explaino_seed.cpp .\src\diagnostics_state_io.cpp .\src\diagnostics_capture.cpp .\src\render_capture_guard.cpp .\tests\test_diagnostics_state_io.cpp ^
  /Fe:"%TESTROOT%\test_diagnostics_state_io.exe"
if errorlevel 1 exit /b 1
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\fractal_viewport_facts.cpp .\src\finding_archive_actions.cpp .\src\diagnostics_capture.cpp .\src\render_capture_guard.cpp .\tests\test_finding_archive_actions.cpp ^
  /Fe:"%TESTROOT%\test_finding_archive_actions.exe"
if errorlevel 1 exit /b 1
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\view_hp_sync.cpp .\src\explaino_seed.cpp .\src\fractal_derived_fields.cpp .\src\runtime_reset.cpp .\tests\test_runtime_reset.cpp ^
...
:focused_test_fractal_viewport_facts
cl /nologo /EHsc /MD /std:c++17 /O2 /I. /I.\src ^
  .\src\fractal_viewport_facts.cpp .\tests\test_fractal_viewport_facts.cpp ^
  /Fe:"%TESTROOT%\test_fractal_viewport_facts.exe"
if errorlevel 1 exit /b 1
