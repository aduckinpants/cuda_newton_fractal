...
int main() {
...

    {
        ...
        std::string error;
        params.coloring_mode = ColoringMode::smooth_escape;
        const FractalType multibrotLanes[] = {FractalType::multibrot, FractalType::explaino_multibrot_root_trap};
        for (FractalType multibrotLane : multibrotLanes) {
            view.fractal_type = multibrotLane;
