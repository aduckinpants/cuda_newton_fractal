...
bool ValidateVisibleControlMatrix() {
    ...
    const MatrixCase cases[] = {
        ...
        {"magnet_seed_real", FractalType::explaino_magnet_root_well, "fractal.params.magnet_seed_real", "float"},
        {"magnet_seed_imag", FractalType::explaino_magnet_root_well, "fractal.params.magnet_seed_imag", "float"},
        {"magnet_relaxation", FractalType::explaino_magnet_root_well, "fractal.params.magnet_relaxation", "float"},
        {"magnet_bailout", FractalType::explaino_magnet_root_well, "fractal.params.magnet_bailout", "float"},
