...
- Logged pytest: `py -3.14 tools/viewer_host_run_logged_command.py --label sdf_row_field_resolution_authority_reds_pytest --log artifacts/logs/sdf_row_field_resolution_authority_reds_pytest.log --out-json artifacts/validation/sdf_row_field_resolution_authority_reds_pytest.json --heartbeat-seconds 30 --timeout-seconds 120 -- py -3.14 -m pytest tests/test_sdf_row_field_resolution_authority_reds.py -q` passed, `2 passed`.
