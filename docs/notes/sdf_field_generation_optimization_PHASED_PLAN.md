...
- Witness unit: `py -3.14 tools/viewer_host_run_logged_command.py --label sdf_field_generation_witness_unit --log artifacts/logs/sdf_field_generation_witness_unit.log --out-json artifacts/validation/sdf_field_generation_witness_unit.json --heartbeat-seconds 30 --timeout-seconds 300 -- py -3.14 -m pytest tests/test_sdf_performance_witness_tool.py -q` passed.
