...
- When creating or refreshing a meaningful phased plan, include `## Explicit User Asks`, `## Proof Ledger`, `## Hostile Audit`, `## Audit Passes`, and `## Audit Findings` alongside the required phase-tracking sections.
