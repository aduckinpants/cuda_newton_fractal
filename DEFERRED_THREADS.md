...
| 7 | Color Pipeline composition follow-ups | Medium | High | UI-Salt backend authority, preset workflow truth, visible implementation-wording cleanup, and SDF Normal Angle Beauty are shipped. Remaining bounded follow-ups are SDF masks/gates and function-library taxonomy/layout work. |
